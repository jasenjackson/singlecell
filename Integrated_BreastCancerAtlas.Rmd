...
knitr::opts_chunk$set(
  fig.path = "figures/Integrated_BreastCancerAtlas-", 
  echo = TRUE)
``` 
...
Now we separate malignant cells by cell line and plot these markers to look for cell-line specific distributions. 
## MCF7_1
```{r}
...
It may be better to create a UMAP density plot for each sample and show them altogether. 

And maybe I'm going ab this wrong. Maybe I can create a score for each mega-cluster and sort out each...
MONDAY'S PROBLEM HAPPY FRIDAY
```{r}
```
